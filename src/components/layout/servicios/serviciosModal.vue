                           ...
                           <h3>{{servicio}}</h3>
                            <fieldset :disabled="loading">
                                <form method="post" @submit.prevent="enviarMsg">
                                    <div class="form-group"><input class="form-control" type="text"  v-model="ctaName" :placeholder="$t('Componentes.InputsPlaceholder.Nombre')" required></div>
                                    <div class="form-group"><input class="form-control" type="tel" v-model="ctaPhone" :placeholder="$t('Componentes.InputsPlaceholder.Telefono')" required></div>
